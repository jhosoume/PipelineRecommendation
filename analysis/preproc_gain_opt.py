...
for baseline in results:
    ...
    #     )
    # )
    fig.write_image("analysis/plots/preproc_gain/opt_" + SCORE + "_" + baseline + "normalized.eps")
    fig.write_image("analysis/plots/preproc_gain/opt_" + SCORE + "_" + baseline + "normalized.png")
