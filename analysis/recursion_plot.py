...
for round in range(len(results["pp_wins"]["svm"])):
    data_plot = []
    ...
    fig.write_image("analysis/plots/recursion/round.{}.eps".format(round))
    fig.write_image("analysis/plots/recursion/round.{}.png".format(round))
