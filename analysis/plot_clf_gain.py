...
with open("analysis/plots/clf_gain/balanced_accuracy_mean_normalized_rep_{}.json".format(REP), "r") as fd:
...
for baseline in results:
    ...
    #     )
    # )
    fig.write_image("analysis/plots/clf_gain/" + baseline + "_" + SCORE + "_rep_normalized.eps")
    fig.write_image("analysis/plots/clf_gain/" + baseline + "_" + SCORE + "_rep_normalized.png")
    fig.write_image("/home/jhosoume/unb/tcc/ICDM/img/clf_winnings/" + baseline  + "_" + SCORE + "_rep_normalized.eps")
    fig.write_image("/home/jhosoume/unb/tcc/ICDM/img/clf_winnings/" + baseline + "_" + SCORE + "_rep_normalized.png")
